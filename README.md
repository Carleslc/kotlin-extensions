...
```
dependencies {
    compile 'com.github.carleslc:kotlin-extensions:0.7'
}
```
...
Otherwise you will need to add the `kotlin-extensions-0.7.jar` from generated `target` folder as external dependency of your project.
