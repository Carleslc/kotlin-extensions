...
inline fun String.toByteOrThrow(throwable: Throwable): Byte = toByteOrRun { throw throwable }
...
inline fun String.toShortOrThrow(throwable: Throwable): Short = toShortOrRun { throw throwable }
...
inline fun String.toIntOrThrow(throwable: Throwable): Int = toIntOrRun { throw throwable }
...
inline fun String.toLongOrThrow(throwable: Throwable): Long = toLongOrRun { throw throwable }
...
inline fun String.toFloatOrThrow(throwable: Throwable): Float = toFloatOrRun { throw throwable }
...
inline fun String.toDoubleOrThrow(throwable: Throwable): Double = toDoubleOrRun { throw throwable }
...
inline fun String.toBooleanOrThrow(throwable: Throwable): Boolean = toBooleanOrRun { throw throwable }
