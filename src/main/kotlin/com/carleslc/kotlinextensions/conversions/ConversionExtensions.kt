...
package com.carleslc.kotlinextensions.conversions

import com.carleslc.kotlinextensions.standard.Try
...
inline fun String.toIntOrNull(): Int? = Try { Integer.parseInt(this) }.getOrNull()
